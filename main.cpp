	...
	char str1[] = "                                ACHARYA INSTITUTE OF TECHNOLOGY";
	char str2[] = "                                             Dept of CSE";
	char str3[] = "COMPUTER GRAPHICS AND VISUALIZATION ";
	char str4[] = "  A PROJECT";
	char str5[] = "   ON";
	char str6[] = "DEMONSTRATION OF BLOCKCHAIN";
	char str7[] = "Submitted By:";
	char str8[] = "PARVATHI CHOUDHARY";
	char str9[] = "*******************************************";
	char str10[] = "-----------------------------------";
	char str11[] = "-----------------------------------------------------------------------------";
	char str12[] = "------------------------------------------------------------------------------------------------------------------------------";
...
int main(int argc, char **argv) {
	...
	glutCreateWindow("Demonstration of BlockChain");
	glutFullScreen();
